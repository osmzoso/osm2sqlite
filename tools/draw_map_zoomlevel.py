...
def show_limit_web_mercator():
    ...
    print(draw_map.wgs84_to_webmercator(180, 85.05112878))
    print(draw_map.wgs84_to_webmercator(-180, -85.05112878))
    print(draw_map.webmercator_to_wgs84(20037508.343, 20037508.343))
    print(draw_map.webmercator_to_wgs84(-20037508.343, -20037508.343))
...
def show_zoomlevel():
    ...
    for zoomlevel in range(21):
        pixel_world_map, meters_pixel = draw_map.size_world_map(zoomlevel)
        print(f'{zoomlevel:5}     '
