...
#
# check whether the own functions calculate correctly
#
for lat in range(1,91):
    print('\n', lat)
    print(db.execute('SELECT AsText( Transform( MakePoint(180.0000000, ?, 4326), 3857) )',(lat,)).fetchone()[0])
    x, y = proj.wgs84_to_webmercator(180, lat)
    print(x, y)
